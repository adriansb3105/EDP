<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EDP.Default" MaintainScrollPositionOnPostback="true" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="MainScriptManager" runat="server" EnableCdn="true"/>

    <asp:Button ID="btnAgregarFuncionario" runat="server" Text="Agregar Funcionario" CssClass="btn btn-primary" OnClick="btnAgregarFuncionario_Click" />
                                ...
                                <ItemTemplate>
						            <tr style="text-align: center">
							            <td>
                                            ...
                                            <asp:LinkButton ID="btnEliminar" runat="server" ToolTip="Deshabilitar" OnClick="btnDeshabilitar_Click" CommandArgument='<%# Eval("numeroIdentificacion") %>'><span class="glyphicon glyphicon-check"></span></asp:LinkButton>
                                        </td>
                                        <td>
    ...
    <script type="text/javascript">
        function levantarModalDeshabilitarFuncionario() {
            $('#modalDeshabilitarFuncionario').modal('show');
        };
    ...
    <div id="modalDeshabilitarFuncionario" class="modal fade" role="alertdialog">
        <div class="modal-dialog">

            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Deshabilitar</h4>
                </div>

                <div class="modal-body">
                    ¿Confirma que desea deshabilitar este funcionario?
                </div>

                <div class="modal-footer">
                    <asp:Button ID="btnConfirmarDeshabilitar" runat="server" Text="Confirmar" CssClass="btn btn-warning" OnClick="btnConfirmarDeshabilitar_Click" />
