...
{
    public partial class Deshabilitados : System.Web.UI.Page
    {
        ...
        private List<Funcionario> cargarFuncionarios()
        {
            ...
            listaFuncionarios = this.funcionarioDatos.ObtenerTodos(false);
        ...
        {
            string numeroIdentificacion = (((LinkButton)(sender)).CommandArgument).ToString();
            this.funcionarioDatos.HabilitarDeshabilitar(numeroIdentificacion, true);
