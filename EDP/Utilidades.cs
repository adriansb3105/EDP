...
namespace AccesoDatos
{
    public static class Utilidades
    {
        ...
        public static int ROL_ADMINISTRADOR = 2;
        public static int ROL_GESTOR = 3;
        ...
        public static bool GuardarFotografias(HttpPostedFile file, String nombreArchivo)
        {
            try
            {
                // Path del directorio donde vamos a guardar el archivo
        ...
        public static int SaveFile(HttpPostedFile file, int year, String nombreArchivo, String carpeta)
        {
            ...
            {
                ErrorBitacora(exception.Message, "Error guardando imagen!");
            }
            return 0;
        }
        ...
        public static void escogerMenu(Page page, int[] rolesPermitidos)
        {
             ...
             * Administrador.........2
             */
            else if (rol == ROL_ADMINISTRADOR)
            {
                if (rolesPermitidos.Contains(rol))
                {
                    page.Master.FindControl("MenuGestor").Visible = false;
            ...
            else if (rol == ROL_GESTOR)
            {
                if (rolesPermitidos.Contains(rol))
                {
                    ...
                    page.Master.FindControl("MenuGestor").Visible = true;
                }
                else
                {
                    page.Session.RemoveAll();
